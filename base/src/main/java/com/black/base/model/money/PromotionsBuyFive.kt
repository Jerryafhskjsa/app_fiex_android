...
//发售促销
class PromotionsBuyFive : Parcelable {
    var id: Long? = null
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<PromotionsBuyFive?> = object : Parcelable.Creator<PromotionsBuyFive?> {
            override fun createFromParcel(`in`: Parcel): PromotionsBuyFive? {
                return PromotionsBuyFive(`in`)
            }

            override fun newArray(size: Int): Array<PromotionsBuyFive?> {
