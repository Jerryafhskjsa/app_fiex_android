...
class PromotionsBuyFiveRecord {
    ...
    fun getGotNoDisplay(context: Context): String {
        return String.format("%s-%s",
                if (ballotNumMin == null) context.resources.getString(R.string.number_default) else ballotNumMin,
                if (ballotNumMax == null) context.resources.getString(R.string.number_default) else ballotNumMax)
    }
}