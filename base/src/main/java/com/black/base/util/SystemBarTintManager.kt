...
class SystemBarTintManager @SuppressLint("ResourceType") @TargetApi(19) constructor(activity: Activity) {
    companion object {
        ...
        init { // Android allows a system property to override the presence of the navigation bar.
...
// See https://github.com/android/platform_frameworks_base/blob/master/policy/src/com/android/internal/policy/impl/PhoneWindowManager.java#L1076
     ...
     */
    class SystemBarConfig internal constructor(activity: Activity, translucentStatusBar: Boolean, traslucentNavBar: Boolean) {
