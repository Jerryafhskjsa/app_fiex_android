...
class WechatMomentsPlatform private constructor(private val mContext: Context) : SharePlatform() {
    ...
    companion object {
        ...
        private var wechatPlatform: WechatMomentsPlatform? = null
        fun getInstance(context: Context): WechatMomentsPlatform {
            if (wechatPlatform == null) {
                wechatPlatform = WechatMomentsPlatform(context)
            }
