...
abstract class NormalObserver<T>(protected var context: Context? = null) : NetObserver<T>() {
...
//                    error = context?.getString(R.string.login_over_time)
                    ...
                    if (context is Activity) {
                        MoneyPasswordVerifyWindow(context as Activity, object : OnMoneyPasswordListener {
                            override fun onReturn(window: MoneyPasswordVerifyWindow, moneyPassword: String?, timeMill: Boolean) {
                                ...
                                RetryRequestHelper.requestQueryAddMoneyPassword(builder, request, moneyPasswordNew, timeMill, this@NormalObserver)
                            }
    ...
    final override fun onReturnResult(result: T) {
