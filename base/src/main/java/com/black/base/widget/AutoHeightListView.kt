...
import com.black.base.widget.AutoHeightListView
...
class AutoHeightListView(context: Context?, attrs: AttributeSet?) : ListView(context, attrs),
    OnTouchListener, AbsListView.OnScrollListener {
    private val listViewTouchAction: Int = -1
        ...
        if (heightMode != MeasureSpec.EXACTLY) {
            ...
            if (listAdapter != null && !listAdapter.isEmpty) {
                ...
                while (listPosition < listAdapter.count
                    ...
                    (listItem as? ViewGroup)?.layoutParams = mLayoutParams
