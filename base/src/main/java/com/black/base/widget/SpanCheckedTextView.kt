...
class SpanCheckedTextView @JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : SkinCompatCheckedTextView(context, attrs, defStyleAttr) {
    override fun setTextAppearance(resId: Int) {
        setTextAppearance(context, resId)
    }

    override fun setText(text: CharSequence, type: BufferType) { //        if (!(text instanceof Spannable)) {
