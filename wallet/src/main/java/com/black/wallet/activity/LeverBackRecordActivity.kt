...
import com.black.wallet.adapter.LeverBackRecordAdapter
import com.black.wallet.databinding.ActivityLeverBackRecordBinding
import skin.support.content.res.SkinCompatResources
import java.util.*

@Route(value = [RouterConstData.LEVER_BACK_RECORD], beforePath = RouterConstData.LOGIN)
class LeverBackRecordActivity : BaseActionBarActivity(), QRefreshLayout.OnRefreshListener, QRefreshLayout.OnLoadListener, QRefreshLayout.OnLoadMoreCheckListener {
    private var pair: String? = null

    private var binding: ActivityLeverBackRecordBinding? = null

    private var adapter: LeverBackRecordAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_lever_back_record)
        ...
        adapter = LeverBackRecordAdapter(mContext, BR.listItemLeverBackRecordModel, null)
