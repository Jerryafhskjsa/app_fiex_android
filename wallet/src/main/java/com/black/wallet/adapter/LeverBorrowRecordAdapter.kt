...
import com.black.wallet.databinding.ListItemLeverBorrowBinding

class LeverBorrowRecordAdapter(context: Context, variableId: Int, data: ArrayList<LeverBorrowRecord?>?) : BaseRecycleDataBindAdapter<LeverBorrowRecord?, ListItemLeverBorrowBinding>(context, variableId, data) {
    override fun getResourceId(): Int {
        return R.layout.list_item_lever_borrow
    }

    override fun onBindViewHolder(holder: BaseViewHolder<ListItemLeverBorrowBinding>, position: Int) {
