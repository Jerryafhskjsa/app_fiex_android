...
class HomeContractDetailAdapter(context: Context, data: MutableList<PairStatus?>?) : BaseDataTypeBindAdapter<PairStatus?, ListItemContractRecordDetailBinding>(context, data) {
