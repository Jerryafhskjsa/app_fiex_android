...
import com.fbsex.exchange.databinding.ListFutureMsgBinding

//指标选择器
class FutureMSG(activity: Activity) : PopupWindow.OnDismissListener, View.OnClickListener {
    private val popupWindow: PopupWindow?
    private val margin: Float
    private var onKLineQuotaSelectorListener: OnKLineQuotaSelectorListener? = null
    private var type: String? = null

    private val binding: ListFutureMsgBinding

    init {
        val inflater = LayoutInflater.from(activity)
        binding = DataBindingUtil.inflate(inflater, R.layout.list_future_msg, null, false)
