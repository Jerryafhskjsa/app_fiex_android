...
class C2CCustomerBuyFragment : BaseFragment() {
    private var binding: FragmentC2cCustomerBuyBinding? = null

    private var supportCoins: ArrayList<C2CSupportCoin?>? = null
    private var fragmentList: MutableList<C2CCustomerBuyItemFragment>? = null
        ...
        if (binding?.coinTab != null) {
            ...
            if (supportCoins != null && supportCoins!!.isNotEmpty()) {
                ...
                for (i in 0 until size) {
                    ...
                    try {
                        val itemFragment = C2CCustomerBuyItemFragment()
                        val bundle = Bundle()
