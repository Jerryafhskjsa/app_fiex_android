...
import com.black.c2c.databinding.FragmentC2cOneKeyBuyBinding
import com.google.android.material.tabs.TabLayout
import skin.support.content.res.SkinCompatResources
import java.util.*

class C2COneKeyBuyFragment : BaseFragment() {
    private var binding: FragmentC2cOneKeyBuyBinding? = null
    private var supportCoins: ArrayList<C2CSupportCoin>? = null
    private var fragmentList: MutableList<C2COneKeyBuyItemFragment>? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_c2c_one_key_buy, container, false)
        ...
        if (binding?.coinTab != null) {
            ...
            if (supportCoins != null && supportCoins!!.isNotEmpty()) {
                ...
                for (i in 0 until size) {
                    ...
                    try {
                        val itemFragment = C2COneKeyBuyItemFragment()
                        val bundle = Bundle()
