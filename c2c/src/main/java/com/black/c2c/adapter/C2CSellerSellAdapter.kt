...
class C2CSellerSellAdapter(context: Context, variableId: Int, data: ArrayList<C2CSeller?>?) : BaseRecycleDataBindAdapter<C2CSeller?, ListItemC2cSellerSellBinding>(context, variableId, data) {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<ListItemC2cSellerSellBinding>, position: Int) {
        ...
        if (paymentTypeList != null && paymentTypeList.isNotEmpty() && paymentTypeList.contains(C2CPayment.WECHAT)) {
