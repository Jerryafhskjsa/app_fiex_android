...
class CameraMachine(val context: Context, view: CameraView, cameraOpenOverCallback: CameraInterface.CameraOpenOverCallback?) : State {
    var state: State
    val view: CameraView
    //获取空闲状态
    //    private CameraInterface.CameraOpenOverCallback cameraOpenOverCallback;
    val previewState: State//浏览状态(空闲)
    //获取浏览图片状态
    val borrowPictureState: State //浏览图片
    //获取浏览视频状态
    val borrowVideoState: State //浏览视频
