 ...
 * @author lsjwzh
 */
class ExpandableStickyListHeadersAdapter(private val mInnerAdapter: StickyListHeadersAdapter) : BaseAdapter(), StickyListHeadersAdapter {
    ...
    fun getItemViewsByHeaderId(headerId: Long): List<View>? {
        return mHeaderIdToViewMap[headerId.toInt()]
    }
